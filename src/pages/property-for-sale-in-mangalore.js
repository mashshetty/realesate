    ...
    <div className={Styles.topmaincontainer}>
      <div className={Styles.container}>
        ...
        <div>
          ...
          Find adaptable land for sale in Mangalore that may be used for both residential and agricultural purposes. These plots provide a unique combination of natural beauty and possibilities, whether you intend to develop the land or construct your dream house. Adaptable to your vision, secure your own piece of Mangalore right away.
          </h2>
        </div>
