...
function Aboutus() {
  return (
       <div className={Styles.about}>
        ...
        Karkala,<Link href="/property-for-sale-in-udupi">  Udupi</Link>, and <Link href="/property-for-sale-in-mangalore">  Mangalore </Link>. Our real estate website provides a
